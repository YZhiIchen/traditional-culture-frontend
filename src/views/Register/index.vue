      ...
      >
        ...
        <el-form-item prop="password">
          <div class="input-group">
            ...
            <input v-model="form.password" type="password" placeholder="密码" class="input-field" autocomplete="new-password" />
          </div>
        </el-form-item>
        ...
        <el-form-item prop="confirmPassword">
          <div class="input-group">
            ...
            <input v-model="form.confirmPassword" type="password" placeholder="确认密码" class="input-field" autocomplete="new-password" />
          </div>
        </el-form-item>
